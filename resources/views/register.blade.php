...
<head>
    ...
    <link href="/templatelogin/css/sb-admin-2.min.css" rel="stylesheet">
...
<body class="bg-gradient-primary">
    ...
    <script src="/templatelogin/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="/templatelogin/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="/templatelogin/js/sb-admin-2.min.js"></script>
